...
namespace NoteAppUnitTest
{
    ...
    {
        [Test(Description = "Тест для десериализации")]
        public void DeserializerTest()
        {
            ...
            Project Load = ProjectManager.Load(filePath);

            Assert.AreNotEqual(project, Load);
        }

        [Test(Description = "Тест для сериализации")]
